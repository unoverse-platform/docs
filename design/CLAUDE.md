...
Condensed, non-negotiable rules for building unoverse components and apps. Full journey: [README](/design/overview), docs 01, 09. Deep reference: `docs/unoverse/UNOVERSE_AUTHORING.md`, `UNOVERSE_STATE_MODEL.md` (§5 = the six rules), `UNOVERSE_LAYERS.md`, `UNOVERSE_CONFORMANCE.md`.
