...
- ❌ Never size or restyle a component from the template: a component owns its faces ([03](/design/components)); the template owns only the framing.
...
- [ ] Preview in **Studio**: layout pills × local states, then live ([07](/design/studio)); publish passes lint with 0 errors
